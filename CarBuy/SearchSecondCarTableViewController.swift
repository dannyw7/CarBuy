//
//  SearchSecondCarTableViewController.swift
//  CarBuy
//
...
class SearchSecondCarTableViewController: UITableViewController {
    
    var firstCarSearchDataPassed2 = [String: AnyObject]()
    ...
    override func viewDidLoad() {
        ...
        if let jsonDataFromApiUrl = jsonData {
            ...
            do {
                ...
                //print(dictionaryOfCompanyJsonData)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Car Listing2", for: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        performSegue(withIdentifier: "showCompare", sender: self)
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        // Get the new view controller using segue.destinationViewController.
        // Pass the selected object to the new view controller.
        if segue.identifier == "showCompare" {
            
            // Obtain the object reference of the destination view controller
            let compareViewController: CompareViewController = segue.destination as! CompareViewController
            
            // Pass the data object to the downstream view controller object
            compareViewController.firstCar = firstCarSearchDataPassed2
            compareViewController.secondCar = carDataToPass
