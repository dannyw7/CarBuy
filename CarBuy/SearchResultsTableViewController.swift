...
class SearchResultsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            ...
            showAlertMessage(messageHeader: "No results to show!", messageBody: "Either there are no results to show or you entered in an improper query such as special characters!")
            return
        }
        ...
        if let jsonDataFromApiUrl = jsonData {
            ...
            do {
                ...
                let dictionaryOfCarData = jsonDataDictionary as! Dictionary<String, AnyObject>
                results = dictionaryOfCarData["listings"] as! [[String: AnyObject]]
                let num_found = dictionaryOfCarData["num_found"] as! NSNumber
                if (num_found == 0) {
    ...
    /*
     --------------------------------------
     MARK: - Prepare and return a cell
     --------------------------------------
     */
    ...
    /*
     --------------------------------------
     MARK: - Table Row Tapped
     --------------------------------------
     */
    // Tapping a row displays data about the selected car for sale
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        
        let rowNumber = (indexPath as NSIndexPath).row
        
        // Obtain the selectedCar
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "Listing" {
            
            // Obtain the object reference of the destination view controller
            let listingDataViewController: ListingDataViewController = segue.destination as! ListingDataViewController
            
            // Pass the data object to the downstream view controller object
            listingDataViewController.carListingDataPassed = carDataToPass
